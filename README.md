...
## React Stuy Plan App
**리액트** 만든 *스터디 플랜 앱*입니다. filter/sort/map/find 메소드로 데이터를 정렬하고, 조건에 맞는 필터 기능을 포함하고 있습니다.
...
- react-swiper -> 스와이퍼
- react-tabs -> 탭기능
- react-styled-components -> 스타일컴포넌트
...
#### 썸네일
![studyplan App](https://github.com/HeoSsaM
/react-studyplan-app/raw/main/public/images/study-plan-thumbnail.png)
